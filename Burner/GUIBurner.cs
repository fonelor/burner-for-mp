...
namespace Burner
{
  ...
  /// </summary>
  [PluginIcons("Burner.Burner.gif", "Burner.BurnerDisabled.gif")]
  public class GUIBurner : GUIInternalWindow, ISetupForm, IShowPlugin
  {
    ...
    private static MediaInfo MI = new MediaInfo(); // MediaInfo dll 
    ...
    private void LoadSettings()
    {
      ...
      tmpFolder = MediaPortal.Util.Utils.RemoveTrailingSlash(tmpFolder);
      ...
      switch (message.Message)
      {
        ...
        case GUIMessage.MessageType.GUI_MSG_CLICKED:
            ...
            // User click on one of the files in the BurnList. Which will remove that file
          {
            ...
            if (iAction == (int)MediaPortal.GUI.Library.Action.ActionType.ACTION_SELECT_ITEM)
            {
              bool sel = true;
    ...
    private void ImportVideoPlaylist()
    {
      ...
      for (int i = 0; i < NumberOfFiles; i++)
      {
        ...
        Item.FileInfo = new FileInformation(Item.Path, false);
        ...
        */
        ...
        MusicTag tag = TagReader.ReadTag(Item.Path);
        if (tag != null)
        {
            Item.MusicTag = tag;
            // Commented until MusicTag supports more formats like ts, flv and other.
        ...
        if (dlgYesNo.IsConfirmed)
        {
          ...
          for (int i = 0; i < NumberOfFiles; i++)
          {
            ...
            try
            {
              ...
              Log.Info("BurnDVD Add File: {0}", cItem.Path);
            }
            catch (Exception ex)
            {
      ...
      if (dlgYesNo != null)
      {
        ...
        if (dlgYesNo.IsConfirmed) // Burn the CD
        {
          ...
          for (int i = 0; i < count; i++)
          {
            ...
            {
              string strTempFolder = MediaPortal.Util.Utils.RemoveTrailingSlash(tmpFolder);
    ...
    {
      return "Gucky62, EgonSpenglerUk, Rolenof";
    }
