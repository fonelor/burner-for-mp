...
namespace Burner
{
  ...
  public partial class BurnerSetupForm : MPConfigForm
  {
     ...
     private bool checkCygwinPath()
    {
      ...
      try
      {
        string cygwinPath = Config.GetFile(Config.Dir.Base, @"Burner\", "mkisofs.exe");
    ...
    private void linkLabelCygwinDownload_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
      try
      {
          Help.ShowHelp(this, @"http://mp-plugins.svn.sourceforge.net/viewvc/mp-plugins/trunk/plugins/Burner/dep/Burner.7z");
      }
      catch {}
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.groupBoxSupportFiles.Size = new System.Drawing.Size(616, 51);
        ...
        this.linkLabelCygwinDownload.LinkArea = new System.Windows.Forms.LinkArea(46, 7);
        this.linkLabelCygwinDownload.Location = new System.Drawing.Point(52, 27);
        this.linkLabelCygwinDownload.Name = "linkLabelCygwinDownload";
        this.linkLabelCygwinDownload.Size = new System.Drawing.Size(541, 17);
        this.linkLabelCygwinDownload.TabIndex = 67;
        this.linkLabelCygwinDownload.TabStop = true;
        this.linkLabelCygwinDownload.Text = "Please reinstall the plugin, or download this packege and put it\'s folder into Me" +
            "diaPortal\'s root directory";
        ...
        this.buttonCancel.Location = new System.Drawing.Point(540, 330);
        ...
        this.buttonOK.Location = new System.Drawing.Point(437, 330);
